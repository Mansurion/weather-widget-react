...
const App = () => {
  ...
  const weatherUrl = `https://api.open-meteo.com/v1/forecast?${selectedCity}&current=temperature_2m&daily=temperature_2m_max,temperature_2m_min&timezone=auto&hello=hahaha`;
